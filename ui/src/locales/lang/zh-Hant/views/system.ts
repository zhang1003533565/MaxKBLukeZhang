export default {
  ...
  knowledgeOpenAPI: {
    title: '開放 API',
    description: '用 API Key 將知識庫能力開放給外部項目，並按當前用戶和工作空間權限隔離資料。',
    accessConfig: '訪問配置',
    baseUrl: '訪問位址',
    apiKey: 'API Key',
    createKey: '生成密鑰',
    ...
    testTitle: '接口測試',
    endpoint: '接口',
    selectKey: '請選擇 API Key',
    knowledgeId: '知識庫 ID',
    knowledgeIds: '知識庫 ID 列表（逗號分隔）',
    documentId: '文檔 ID',
    queryText: '檢索問題',
    file: '文件',
    selectFile: '選擇文件',
    sendTest: '測試接口',
    deleteConfirm: '確定刪除這個 API Key 嗎？刪除後外部系統將無法繼續訪問。',
    docs: {
      knowledges: '分頁獲取當前 API Key 可訪問的知識庫。',
      documents: '分頁獲取指定知識庫下的文檔。',
      upload: '上傳文件、自動分段、創建文檔並進入向量化隊列。',
      paragraphs: '分頁獲取指定文檔的分段內容。',
      hitTest: '對一個或多個知識庫執行召回測試，返回命中的分段。',
    },
    testTypes: {
      knowledges: '知識庫列表',
      documents: '文檔列表',
