export default {
  ...
  knowledgeOpenAPI: {
    ...
    docs: {
      ...
      upload:
        'Upload files, split them, create documents, and enqueue vectorization. Supports split_strategy=llm_text or llm_vision; model_id is required for LLM split strategies.',
