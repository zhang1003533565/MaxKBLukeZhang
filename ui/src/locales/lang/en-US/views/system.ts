export default {
  ...
  knowledgeOpenAPI: {
    title: 'Open API',
    description:
      'Expose knowledge-base capabilities to external projects with API keys, scoped by the current user and workspace permissions.',
    ...
    testTitle: 'API Test',
    endpoint: 'Endpoint',
    selectKey: 'Please select an API Key',
    knowledgeId: 'Knowledge ID',
    knowledgeIds: 'Knowledge IDs, comma-separated',
    documentId: 'Document ID',
    queryText: 'Query',
    file: 'File',
    selectFile: 'Select File',
    splitStrategy: 'Split Strategy',
    splitStrategyPlaceholder: 'Select a split strategy',
    splitStrategyDefault: 'Default Split',
    splitStrategyLlmText: 'LLM Text Split',
    splitStrategyLlmVision: 'LLM Vision Split',
    modelId: 'Model ID',
    visionModelId: 'Vision Model ID',
    llmModelId: 'Text LLM Model ID',
    sendTest: 'Test API',
    ...
    modelIdRequired: 'Please enter a Model ID when using an LLM split strategy',
    visionModelsRequired: 'Vision splitting requires both a vision model ID and a text LLM model ID',
    ...
    docs: {
      ...
      upload:
        'Upload files, split them, create documents, and enqueue vectorization. llm_text requires model_id; llm_vision requires vision_model_id and llm_model_id.',
      paragraphs: 'Get paginated paragraph sections for a document.',
      hitTest: 'Run retrieval testing on one or more knowledge bases and return matched sections.',
    },
    testTypes: {
