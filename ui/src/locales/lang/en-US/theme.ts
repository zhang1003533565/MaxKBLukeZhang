export default {
  ...
  defaultTip: 'The default is the Flow Knowledge Base platform interface, supports custom settings',
  logoDefaultTip: 'The default is the Flow Knowledge Base login interface, supports custom settings',
