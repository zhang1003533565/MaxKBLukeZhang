...
urlpatterns = [
    ...
    path('workspace/<str:workspace_id>/knowledge/<str:knowledge_id>/document/<str:document_id>/quality/task', views.DocumentView.QualityTask.as_view()),
    path('workspace/<str:workspace_id>/knowledge/<str:knowledge_id>/document/<str:document_id>/quality/task/<str:task_id>', views.DocumentView.QualityTaskStatus.as_view()),
    path('workspace/<str:workspace_id>/knowledge/<str:knowledge_id>/document/<str:document_id>/quality/task/<str:task_id>/apply', views.DocumentView.QualityTaskApply.as_view()),
